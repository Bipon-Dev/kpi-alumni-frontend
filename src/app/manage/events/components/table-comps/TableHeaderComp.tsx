    ...
    return (
        <TableHeader>
            <TableRow className="!border-b-0 h-[50px]">
                ...
                <TableHead className="w-[151px] text-primary bg-primary-100 font-medium text-left">Event Time</TableHead>
                ...
                <TableHead className="w-[80px] text-primary bg-primary-100 font-medium text-right rounded-r-[15px]">Action</TableHead>
            </TableRow>
        </TableHeader>
    );
};
