    ...
    return (
        <TableHeader>
            <TableRow className="!border-b-0 h-[50px]">
                ...
                <TableHead className="w-[180px] text-primary bg-primary-100 font-medium text-justify">Company</TableHead>
                ...
                <TableHead className="w-[120px] text-primary bg-primary-100 font-medium text-left">Experience</TableHead>
                <TableHead className="w-[100px] text-primary bg-primary-100 font-medium text-left">Location</TableHead>
